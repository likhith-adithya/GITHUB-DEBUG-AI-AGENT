...
def test_llm_client_init_ollama(mock_async_openai, mock_ollama_env):
    ...
    mock_async_openai.assert_called_once_with(api_key="ollama", base_url="http://localhost:11434/v1")
...
def test_llm_client_init_huggingface2(mock_async_openai, monkeypatch):
    ...
    mock_async_openai.assert_called_once_with(api_key="hf_test", base_url="https://router.huggingface.co/sambanova/v1")
...
def test_llm_client_init_openrouter(mock_async_openai, monkeypatch):
    ...
    mock_async_openai.assert_called_once_with(api_key="sk-or-test", base_url="https://openrouter.ai/api/v1")
...
def test_llm_client_init_google(mock_async_openai, monkeypatch):
    ...
    mock_async_openai.assert_called_once_with(api_key="gemini_test_key", base_url="https://generativelanguage.googleapis.com/v1beta/openai/")
